            ...
            <div class="card-body mt-4 mb-4">
                <div class="row  ">
                    ...
                    <div class="col-md-10 ms-5">
                        <form action="/admin/settambahkendaraan" method ="POST">
                        @csrf   
                                <div class="mb-2">
                                    <label for="exampleInputEmail1" class="form-label">Kendaraan</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="kendaraan">
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">Tanggal Terakhir Servis</label>
                                    <input type="date" class="form-control" id="exampleInputPassword1" name="servisterakhir">
                                </div>
                                 <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">Tanggal Servis akan datang</label>
                                    <input type="date" class="form-control" id="exampleInputPassword1" name="servislanjutan">
                                </div>
                                <div class="mb-2">
